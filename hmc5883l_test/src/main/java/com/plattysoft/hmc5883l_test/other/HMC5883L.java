...
package com.plattysoft.hmc5883l_test.other;
...
public class HMC5883L implements AutoCloseable {
    ...
    public static final int SAMPLES_AVARAGE_START = 0x05;
    public static final int SAMPLES_AVARAGE_LENGTH = 0x02;
    public static final int SAMPLES_AVARAGE_1 = 0x00;
    public static final int SAMPLES_AVARAGE_2 = 0x01;
    public static final int SAMPLES_AVARAGE_4 = 0x02;
    public static final int SAMPLES_AVARAGE_8 = 0x03;

    public static final int OUTPUT_RATE_START = 0x02;
    public static final int OUTPUT_RATE_LENGTH = 0x03;
    public static final int OUTPUT_RATE_0 = 0x00;
    public static final int OUTPUT_RATE_1 = 0x01;
    public static final int OUTPUT_RATE_2 = 0x02;
    public static final int OUTPUT_RATE_3 = 0x03;
    public static final int OUTPUT_RATE_4 = 0x04;
    public static final int OUTPUT_RATE_5 = 0x05;
    public static final int OUTPUT_RATE_6 = 0x06;
    public static final int OUTPUT_RATE_7 = 0x07;

    public static final int MEASUREMENT_START = 0x00;
    public static final int MEASUREMENT_LENGTH = 0x02;
    public static final int MEASUREMENT_NORMAL = 0x00;
    public static final int MEASUREMENT_POSITIVE = 0x01;
    public static final int MEASUREMENT_NEGATIVE = 0x02;

    public static final int GAIN_START = 0x05;
    public static final int GAIN_LENGTH = 0x03;
    public static final int GAIN_1370 = 0x00;
    public static final int GAIN_1090 = 0x01;
    public static final int GAIN_820 = 0x02;
    public static final int GAIN_660 = 0x03;
    public static final int GAIN_440 = 0x04;
    public static final int GAIN_390 = 0x05;
    public static final int GAIN_330 = 0x06;
    public static final int GAIN_230 = 0x07;

    public static final int OPERATION_MODE_START = 0x00;
    public static final int OPERATION_MODE_LENGTH = 0x02;
    public static final int OPERATION_MODE_CONT = 0x00;
    public static final int OPERATION_MODE_SINGLE = 0x01;
    public static final int OPERATION_MODE_IDLE = 0x02;
